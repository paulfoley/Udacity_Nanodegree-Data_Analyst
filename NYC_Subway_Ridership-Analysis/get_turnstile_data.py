'''
This script uses the MTA Subway Turnstile data and returns hourly exits, entries 
As well as queries the data for Regular Entries.
'''
...
## Data
turnstile_data = pd.read_csv('turnstile_updated.txt', sep = ',', names = ['C/A','UNIT','SCP','DATEn','TIMEn','DESCn','ENTRIESn','EXITSn'])
