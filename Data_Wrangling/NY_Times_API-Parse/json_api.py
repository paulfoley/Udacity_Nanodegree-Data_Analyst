## Quiz using an API to Get a JSON File
...
def test():
    ...
    print(len(titles)) # 20
    print(len(urls)) # 30
    print(titles[2]) # {'Opinion': 'Professors, We Need You!'}
    print(urls[20]) # 'http://graphics8.nytimes.com/images/2014/02/17/sports/ICEDANCE/ICEDANCE-thumbStandard.jpg'
